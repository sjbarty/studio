      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 xl:col-span-9">
          <Card className="overflow-hidden">
            <div 
              className="relative w-full aspect-[4/3] flex items-center justify-center transition-colors"
        ...
        <div className="lg:col-span-4 xl:col-span-3 space-y-6">
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2"><Palette size={20} /> Background Color</CardTitle>
                    <CardDescription>Pick a color for the background.</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid grid-cols-6 gap-2">
                        {BG_COLORS.map(color => (
                            <button
                                ...
                                className={cn("w-full aspect-square rounded-md border-2", bgColor === color ? "border-primary ring-2 ring-primary ring-offset-2" : "border-transparent")}
